...
window.onload = function () {
  ...
  submitButton.addEventListener("click", function () {
    ...
    if (selectedProblem === "Cuts and Wounds") {
      window.open("/medicotreat/reg_form/treat/cuts.html", "_blank");
      // You can replace alert with any other action you want to perform
    }
    else if (selectedProblem === "Bruises") {
      window.open("/medicotreat/reg_form/treat/bruises.html", "_blank");
    }
    else if (selectedProblem === "Sprain and Strain") {
      window.open("/medicotreat/reg_form/treat/sprain.html", "_blank");
    }
    else if (selectedProblem === "Fracture") {
      window.open("/medicotreat/reg_form/treat/fracture.html", "_blank");
    }
    else if (selectedProblem === "Itching") {
      window.open("/medicotreat/reg_form/treat/itching.html", "_blank");
    }
    else if (selectedProblem === "Dislocation") {
      window.open("/medicotreat/reg_form/treat/dislocation.html", "_blank");
    }
    else if (selectedProblem === "Fire Injury") {
      window.open("/medicotreat/reg_form/treat/fire.html", "_blank");
    }
    else if (selectedProblem === "Swelling") {
      window.open("/medicotreat/reg_form/treat/swelling.html", "_blank");
    }
    else if (selectedProblem === "Ristricterd Range of Motion") {
      window.open("/medicotreat/reg_form/treat/motion.html", "_blank");
    }
  });
};
